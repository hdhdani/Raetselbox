...
CPP_SOURCES = \
Src/Adafruit_APDS9960.cpp \
Src/asteroids.cpp \
Src/buttonmatrix.cpp \
Src/display.cpp \
Src/farbspiel.cpp \
Src/gameconfig.cpp \
Src/gesturesens.cpp \
...
flash: $(BUILD_DIR)/$(TARGET).elf
	openocd -f interface/stlink.cfg  -f target/stm32l1.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	openocd -f interface/stlink.cfg -f target/stm32l1.cfg -c "init; reset halt; stm32l1x mass_erase 0; exit"
